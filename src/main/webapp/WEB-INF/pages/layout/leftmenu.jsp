<div id="page-sidebar">
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/payment/showPfSlip" title="Buttons"><span>PF Slip</span></a></li>
                <li><a href="${pageContext.request.contextPath}/payment/list" title="Labels &amp; Badges"><span>Pay Slip List</span></a></li>
                <li><a href="${pageContext.request.contextPath}/admitCard/email" title="Labels &amp; Badges"><span>Email Admit Card</span></a></li>
            </ul>
        ...
        <a href="#" title="Elements">
            <i class="glyph-icon icon-linecons-diamond"></i>
            <span>Student G-Suite</span>
        </a>
        <div class="sidebar-submenu">

            <ul>
                <li><a href="${pageContext.request.contextPath}/payment/studentEmail" title="Buttons"><span>Email G-Suite</span></a></li>
                <li><a href="${pageContext.request.contextPath}/payment/printJasper" title="Buttons"><span>Barcode</span></a></li>
                <%--<li><a href="${pageContext.request.contextPath}/payment/list" title="Labels &amp; Badges"><span>Pay Slip List</span></a></li>--%>
            </ul>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                <li><a href="${pageContext.request.contextPath}/taxbankpayment/show" title="Responsive tabs"><span>Tax Certificate</span></a></li>
                <li><a href="${pageContext.request.contextPath}/taxbankpayment/create" title="Collapsables"><span>Bank Challan</span></a></li>
            </ul>
