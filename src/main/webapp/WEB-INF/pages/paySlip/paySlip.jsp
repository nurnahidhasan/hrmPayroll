        ...
        <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" name="item" id="itemForm" method="POST" action="${contextPath}/item/save" modelAttribute="item"  data-parsley-validate="">
                ...
                <div class="row">
                    ...
                    <input style="float: left; margin-left: 5px;" type="button" value="Generate Data" onclick="generateData()" class="btn btn-lg btn-primary"/>
...
<div id="covid" style="display: none;">${response}</div>
